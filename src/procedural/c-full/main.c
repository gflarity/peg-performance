...
int main(int argc, char* argv[])
{
  ...
  games_state=malloc(sizeof(uint_fast64_t)*323873);
  backtrack=malloc(sizeof(uint_fast32_t)*323873);
  solutions_data=malloc(sizeof(int_fast8_t)*13*1550);

  games_state[0]=18003403351261181ULL;//standard initial board in complex form
